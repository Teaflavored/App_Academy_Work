...
ActiveRecord::Schema.define(version: 20141023170604) do
  ...
  add_index "responses", ["user_id", "answer_choice_id"], name: "index_responses_on_user_id_and_answer_choice_id", unique: true, using: :btree
